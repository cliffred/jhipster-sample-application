package red.cliff.repository;

import red.cliff.JhipsterSampleApplicationApp;
import red.cliff.config.Constants;
import red.cliff.config.TestSecurityConfiguration;
import red.cliff.config.audit.AuditEventConverter;
import red.cliff.domain.PersistentAuditEvent;
...
import static red.cliff.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
